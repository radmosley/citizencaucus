...
class BaseBuiltinsFromDSLAssembler: public CodeStubAssembler {
 public:
  ...
  TNode<FixedArray> cast12ATFixedArray(TNode<HeapObject> p_o, Label* label_CastError_731);
  TNode<FixedDoubleArray> cast18ATFixedDoubleArray(TNode<HeapObject> p_o, Label* label_CastError_733);
  TNode<JSArray> cast9ATJSArray(TNode<Object> p_o, Label* label_CastError_737);
  TNode<JSReceiver> cast45UT17ATJSBoundFunction12ATJSFunction9ATJSProxy(TNode<Object> p_o, Label* label_CastError_739);
  TNode<JSArray> cast9ATJSArray(TNode<HeapObject> p_o, Label* label_CastError_736);
  TNode<JSDataView> cast12ATJSDataView(TNode<Object> p_o, Label* label_CastError_770);
